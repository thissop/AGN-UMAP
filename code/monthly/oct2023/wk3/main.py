...
data_directory = 'code/monthly/oct2023/wk3/data/'
data = []
types = []
...
plt.legend()
plt.savefig('code/monthly/oct2023/wk3/plots/analysis/encoder.png', dpi=250)
plt.clf()
plt.close()

# Plot the encoder structure
plot_model(autoencoder, to_file='code/monthly/oct2023/wk3/plots/analysis/encoder_structure.png', show_shapes=True)
...
plt.savefig('code/monthly/oct2023/wk3/plots/analysis/umap.png', dpi=250)
...
4. email joanna. abt lib and lines to fit. 
'''