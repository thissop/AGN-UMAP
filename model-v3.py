...
def load_data(data_dir: str):
    ...
    for file in os.listdir(data_dir):
        if file.endswith('.csv') and 'spec' in file:
            ...
            if name in z_map:
                ...
                Y.append(y / np.median(y))  # Keep normalization if needed
                IVARS.append(ivar)
    ...
    ivar_train, ivar_test, _, _ = train_test_split((IVARS, zs_sorted))
...
y_train, y_test, z_train, z_test, ivar_train, ivar_test = load_data(data_dir)
